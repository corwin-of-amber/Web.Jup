<template>
    ...
    <VirtualKeyboard v-if="options.keyboard.custom" ref="keyboard" :keys="keys"></VirtualKeyboard>
</template>
...
import VirtualKeyboard, { IKeyboard } from './keyboard/basic.vue';
import { QWERTY, BKRT, SEPCOL, PUNCT, weld } from './keyboard/layout';
...
class IApp extends Vue {
    ...
    keys = weld(QWERTY, SEPCOL, BKRT).concat(PUNCT)
